...
\textbf{pokec}~\citep{lim2021large} is a large-scale social network (1.6M nodes, 30.6M edges, binary classification, $h$=0.45) from Slovakia, serving as a scalability test on heterophilic graphs.
