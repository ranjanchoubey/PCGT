...
On 12 benchmarks---including ogbn-arxiv (169K nodes)---PCGT outperforms SGFormer by +4.1\% on Chameleon and +3.7\% on Squirrel, while matching or improving on homophilic datasets (CiteSeer +0.5\%, PubMed +0.7\%) and scaling competitively to large graphs. PCGT ranks first or tied-first on 10 of 12 datasets. Ablations show that the attention mechanism's contribution grows with heterophily, and that each design choice---local attention, global seeds, partition encoding---adds measurable accuracy.
