...
# pretrain
python nb-sample.py --dataset ogbn-papers100M --method sgformer --lr 0.001 --num_layers 3 \
...
# finetune
python nb-sample.py --dataset ogbn-papers100M --data_dir /home/ubuntu --method sgformer --lr 0.0001 --num_layers 3 \
    --hidden_channels 256 --dropout 0.2 --weight_decay 1e-5 --use_residual --use_weight --use_bn --use_init --use_act \
    --ours_layers 1 --ours_dropout 0.5 --ours_use_residual --ours_use_weight --ours_use_bn \
    --use_graph --graph_weight 0.8 \
